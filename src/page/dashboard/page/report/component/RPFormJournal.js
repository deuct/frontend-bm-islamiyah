...
function RPFormJournal(props) {
  const { previewForm, valueForm } = useRPForm("Journal");
            ...
            <Col xs={10} md={10} lg={10}>
              <Form.Group className="mb-2">
                <Row className="justify-content-center">
                  ...
                  <Col xs={6} md={6} lg={6} className="d-flex">
                    <Form.Control
                      type="Date"
                      onChange={(e) => (valueForm.dateStart = e.target.value)}
                    />
                    <div className="strip"></div>
                    <Form.Control
                      type="Date"
                      onChange={(e) => (valueForm.dateEnd = e.target.value)}
                    />
                  </Col>
                </Row>
              </Form.Group>
              <Form.Group className="mb-2">
                <Row className="justify-content-center">
                  ...
                  <Col xs={6} md={6} lg={6}>
                    <Form.Control type="text" value="Journal" readOnly />
                  </Col>
                </Row>
              </Form.Group>
              <Form.Group className="mb-2">
